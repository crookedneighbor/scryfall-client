...
describe('Catalog', function () {
  ...
  it('responds to Array methods', function () {
    ...
    expect(upperCaseNames[0]).to.equal(this.fixtures.catalogOfCardNames.data[0].toUpperCase())
    expect(upperCaseNames[1]).to.equal(this.fixtures.catalogOfCardNames.data[1].toUpperCase())
  })
