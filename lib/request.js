...
function makeRequestFunction (options) {
          ...
          response.on('end', function () {
            try {
              ...
              if (body.object === 'error') {
                ...
                pendingResolveFunction(wrapScryfallResponse(body, {
                  convertSymbolsToSlackEmoji: options.convertSymbolsToSlackEmoji,
                  convertSymbolsToDiscordEmoji: options.convertSymbolsToDiscordEmoji,
  ...
  return function request (endpoint, query) {
