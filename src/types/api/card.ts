...
export class ScryfallCard extends ScryfallCardFace {
  object?: "card";
  // Core Fields
  ...
  // Gameplay Fields
  all_parts?: ScryfallRelatedCard[]; // If this card is closely related to other cards, this property will be an array with Related Card Objects.
  card_faces?: ScryfallCardFace[]; // An array of Card Face objects, if this card is multifaced.
  ...
  games?: Array<GameKind>; // A list of games that this card print is available in, paper, arena, and/or mtgo.
